...
AsgardHTTPeSimConfig_TST_F2_0_2_003_Error_TokenUntrustedOrInvalid.
	...
	${res_config}=    AsgardHTTPConfigNoauth    ${authen}    ${OPERATION_STATUS_AsgardHTTPRegister_40103}    ${VALUE_CONFIGINFO_KEY_REFRESHTIME}
	...
	Log HTTP Config    ${CODE_40103}    ${RESULTDESC_THE_TOKEN_IS_UNTRUSTED_OR_INVALID}    ${orderRef}    ${ThingToken}    ${endPointName_detail_list}    ${identity}    ${custom}    ${body}        

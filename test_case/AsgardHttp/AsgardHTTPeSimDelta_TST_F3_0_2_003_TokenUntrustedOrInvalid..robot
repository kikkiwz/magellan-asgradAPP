...
AsgardHTTPeSimDelta_TST_F3_0_2_003_TokenUntrustedOrInvalid.
	...
	${res_delta}=    AsgardHTTPDeltaNoauth    ${authen}    ${OPERATION_STATUS_AsgardHTTPRegister_40103}
	...
	Log HTTP Delta    ${CODE_40103}    ${RESULTDESC_THE_TOKEN_IS_UNTRUSTED_OR_INVALID}    ${orderRef}    ${ThingToken}    ${endPointName_detail_list}    ${identity}    ${custom}    ${body}    

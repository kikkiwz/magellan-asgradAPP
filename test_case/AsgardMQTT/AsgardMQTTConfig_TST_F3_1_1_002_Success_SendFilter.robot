...
*** Test Cases ***
################### Post ###################
AsgardMQTTConfig_TST_F3_1_1_002_Success_SendFilter
	...
	# Report Success
	${responseMQTTConfig}=    MQTTConfig    ${IMSI}    ${VALUE_CONFIGINFO_KEY_REFRESHTIME}    2 
	${ThingToken_MQTT}=    Set Variable    ${responseMQTTConfig}[0]
	${valueKeyResponse}=    Set Variable    ${responseMQTTConfig}[1]
	# Check log detail and summary
	Log MQTT Config    ${ThingID}    ${ThingToken_MQTT}    ${IMSI}    ${IMEI}    ${VALUE_CONFIGINFO_KEY_REFRESHTIME}    2

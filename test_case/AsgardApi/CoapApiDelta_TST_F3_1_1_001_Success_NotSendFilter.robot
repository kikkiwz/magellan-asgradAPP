...
*** Test Cases ***
################### Post ###################
CoapApiDelta_TST_F3_1_1_001_Success_NotSendFilter
	...
	AsgardAPI Log Delta    1    ${CODE_20000}    ${RESULTDESC_THE_REQUESTED_OPERATION_SUCCESSFULLY}    ${CODE_20000}    ${RESULTDESC_THE_REQUESTED_OPERATION_SUCCESSFULLY}    ${createResponse}    ${thingToken}    ${identity}    ${custom}    ${body}    ${endPointName_detail_list}    ${VALUE_SENSORKEY}    ${valueKey}

...
*** Test Cases ***
################### Post ###################
CoapApiConfig_TST_F2_1_1_001_Success_NotSendFilter
	...
	#Send Config
    ${reportResponse}=    AsgardAPI ConfigAsgardApp    ${url_config}    ${ASGARD_COAPAP_IMAGE_RESPONSE_SUCCESS_CONFIG}  
	...
	AsgardAPI Log Config    1    ${CODE_20000}    ${RESULTDESC_THE_REQUESTED_OPERATION_SUCCESSFULLY}    ${CODE_20000}    ${RESULTDESC_THE_REQUESTED_OPERATION_SUCCESSFULLY}    ${createResponse}    ${thingToken}    ${identity}    ${custom}    ${body}    ${endPointName_detail_list}    ${EMPTY}
